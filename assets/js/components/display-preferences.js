const copy = {
  zh: {
    skipLink: "跳到主要内容",
    siteTools: "站点工具",
    eyebrow: "DAVID 的空间工具集",
    titleLead: "专为空间",
    titleAccent: "工作而生。",
    intro: "由 David 独立设计和维护的 GIS 软件、ArcGIS Pro 工具与空间智能实践。",
    nextProduct: "切换产品",
    active: "当前产品",
  ...
  en: {
    ...
    eyebrow: "DAVID'S GEOSPATIAL TOOLSET",
    titleLead: "Tools for",
    titleAccent: "spatial work.",
    intro: "Independent GIS software, ArcGIS Pro tools, and spatial intelligence practice designed and maintained by David.",
