const homeCopy = {
  zh: {
    ...
    titleLead: "尽力让地理数据",
    titleAccent: "触手可及",
    intro: "DvStudio、GDB Previewer 与 DEM Studio：面向 ArcGIS Pro、空间数据查看与地形处理的独立工具。",
    goDownloads: "前往下载",
    contactAuthor: "联系作者",
  ...
  en: {
    ...
    intro: "DvStudio, GDB Previewer, and DEM Studio—independent tools for ArcGIS Pro, spatial data inspection, and terrain workflows.",
